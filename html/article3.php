...
<html lang="fr">
	<head>
		<title>Design And Creation | Contact</title>
		<meta charset="utf-8">
	...
	<body>
		<div class="header header_article">
			<div class="header_texture3 header_article"></div>
			...
			<div class="container">
				...
				<div class="header_slogan">
					<h1 class="header_slogan--title">Me contacter</h1>
		...
		<div class="articles">
			<div class="container">
				<h2 class="articles_title">Contact</h2>
				<div class="articles_items art">
					<div class="profile-card">
						<div class="top-section">
							<i class="message fas fa-envelope"></i>
							<i class="notif fas fa-bell"></i>
							<div class="pic"><img src="../images/DAC3.png" alt=""></div>
							<div class="name">dac</div>
							<div class="tag">@dac</div>
						</div>
						<div class="bottom-section">
							<div class="social-media">
								<a href="https://www.facebook.com/designandcreation39"><i class="fab fa-facebook"></i></a>
								<a href="https://www.instagram.com/designandcreation_rd/"><i class="fab fa-instagram"></i></a>
							</div>
						</div>
					</div>
				</div>
		...
		<footer>
			<div class="parent">
  				...
  				<div class="reseaux">
  					...
  					<a href="https://www.facebook.com/designandcreation39" target="_blank" class="sous_reseaux" id="facebook"><i class="fab fa-facebook-f"></i></a>
  					<a href="https://www.instagram.com/designandcreation_001/" target="_blank" class="sous_reseaux" id="instagram"><i class="fab fa-instagram"></i></a>
