...
<html lang="fr">
	<head>
		<title>Design And Creation | A propos</title>
		<meta charset="utf-8">
	...
	<body>
		<div class="header header_article">
			<div class="header_texture header_article"></div>
			...
			<div class="container">
				...
				<div class="header_slogan">
					<h1 class="header_slogan--title">A propos</h1>
		...
		<div class="article_view-container">
			<div class="article_view">
				<h2 id="titre" class="article_view-title"></h2>
				<h3 id="sous_titre" class="article_view-subtitle"></h3>
				<p id="message" class="article_view-content"></p>
			</div>
		</div>
