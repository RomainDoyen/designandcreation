...
<html lang="fr">
	<head>
		<title>Design And Creation | Portfolio Logo</title>
		<meta charset="utf-8">
		...
		<div class="header header_article">
			...
			<div class="container">
				...
				<div class="header_slogan">
					<h1 class="header_slogan--title">Mon portfolio de logo</h1>
		...
		<div class="gallery-section">
      		<div class="inner-width">
                ...
                <?php 
                    ...
                    $req = $db -> query('SELECT name FROM portfolio_logo');
                    while ($data = $req -> fetch()) {
                        // var_dump($data);
                        echo '
                            <a href="../upload/logo/'.$data['name'].'" class="image">
                                <img src="../upload/logo/'.$data['name'].'">
                            </a>   
                        ';
                    }
				?> 
